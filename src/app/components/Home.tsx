          ...
          >
            ...
            <div className="space-y-2">
              <button
                ...
                className="group bg-gradient-to-br from-purple-500 to-pink-500 p-5 rounded-3xl shadow-md hover:shadow-xl transition-all text-left relative overflow-hidden w-full"
              >
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-yellow-100 to-yellow-50 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity -mr-10 -mt-10"></div>
                <div className="relative">
              ...
              <button
                onClick={() => onNavigate('dragon-demo')}
                className="w-full text-center text-xs text-purple-600 hover:text-purple-800 font-medium underline"
              >
                View Evolution Stages →
              </button>
            </div>
          </motion.div>
        </div>
