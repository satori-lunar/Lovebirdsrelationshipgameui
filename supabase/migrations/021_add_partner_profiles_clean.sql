-- Migration: Partner Profile System (Clean Install)
-- Description: Drop and recreate partner profiles system
-- Date: 2026-01-02
...
DROP TABLE IF EXISTS relationship_needs CASCADE;
DROP TABLE IF EXISTS quiet_mode CASCADE;
