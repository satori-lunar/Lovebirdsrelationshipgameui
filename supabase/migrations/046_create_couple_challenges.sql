...
-- This allows couples to complete challenges together and save their responses
...
INSERT INTO public.couple_challenges (category, title, prompt) VALUES
...
CREATE INDEX idx_challenge_responses_relationship ON public.couple_challenge_responses(relationship_id);
CREATE INDEX idx_challenge_responses_user ON public.couple_challenge_responses(user_id);
CREATE INDEX idx_challenge_responses_challenge ON public.couple_challenge_responses(challenge_id);
CREATE INDEX idx_challenges_category ON public.couple_challenges(category);
