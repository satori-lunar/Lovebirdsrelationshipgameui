-- Migration 013: Enhance suggestions schema for personalized gift, date, and love language suggestions
-- This migration:
-- 1. Renames love_language_suggestions to suggestions (more general)
-- 2. Adds columns for category, personalization data, and metadata
-- 3. Creates suggestion_generation_metadata table for tracking
